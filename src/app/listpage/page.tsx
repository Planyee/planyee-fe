...
const ContentList: React.FC = () => {
  ...
  const array: ArrayType = {
    source: {
      latitude: 37.544917587033986,
      longitude: 126.98504447937054,
    },
    destination: {
      latitude: 37.6104238916314,
  ...
  return MapClick ? (<Mappage locations={array} onbuttonclickhandler={ontestclickhandler}/>) : (
    <div>
